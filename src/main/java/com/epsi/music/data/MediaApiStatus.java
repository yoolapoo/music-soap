package com.epsi.music.data;

public enum MediaApiStatus {

	MEDIA_API_STATUS_1400(1400, "Required parameter(s) invalid/not defined"),
	MEDIA_API_STATUS_1401(1401, "All musics in the library with the given id have been borrowed"),
	MEDIA_API_STATUS_1402(1402, "No music in the library has the given id"),
	MEDIA_API_STATUS_1403(1403, "All musics with the given id are already returned"),
